            ...
            while (isRunning.get()) {
                ...
                if (now-lastCheck > checkInterval) {
                    ...
                    if (nextData.get() != null) {
                        final int[] img = ImageProcessing.decodeYUV420SPtoLuma(nextData.get(), nextWidth.get(), nextHeight.get());
                                ...
                                mHandler.post(new Runnable() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            motionDetectorCallback.onMotionDetected(img, nextWidth.get(), nextHeight.get(), nextData.get());
